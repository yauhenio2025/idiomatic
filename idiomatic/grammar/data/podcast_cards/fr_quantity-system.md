---
series: grammar-walk-cards
episode: 3
format_version: 1
lang: fr
title: "Beaucoup de: fixing your most frequent French mistake"
short_title: "Beaucoup de"
img_style: "Clean flat vector illustration, diagram-meets-editorial style, warm off-white background, deep teal and coral accents, bold simple shapes, generous negative space, large readable sans-serif labels only where the prompt names exact words, no other embedded text, high contrast, legible on a tablet at arm's length"
evidence_refs:
  - "docs/research/error-profiles/fr.md §§2.3(a), 3 pattern 1, and 7"
  - "idiomatic/grammar/data/podcasts/fr_quantity-system.md"
---
...
TL: de langues
[PAUSE:1500]
Keep that one-sound difference in your ear — and flip the card.
...
SHOW: a lot of languages — not "beaucoup des langues"
[PAUSE:1000]
TL: trop de réunions
SHOW: too many meetings
[PAUSE:1000]
TL: assez de temps
SHOW: enough time
[PAUSE:1000]
TL: peu de journalistes
SHOW: few journalists
[PAUSE:1500]
And notice something important: it doesn't matter whether the noun is singular or plural, masculine or feminine. The little word never changes.
TL: beaucoup de vin
TL: beaucoup de réunions
[PAUSE:1500]
When you're ready, flip the card for the one twist this rule has.
...
SHOW: 1. beaucoup / trop / assez / peu → **de** (**d'** before a vowel)
