...
episode: 7
lang: it
title: "Il congiuntivo for people who avoid it"
est_minutes: 16
evidence_refs:
  - "docs/research/error-profiles/it.md §2: 0 recorded congiuntivo errors and 1 implicit teacher target"
  - "docs/research/error-profiles/it.md §5: the target with riesca supports a focused present-congiuntivo contrast"
  - "docs/research/error-profiles/it.md Addendum: congiuntivo is a user-confirmed weakness despite the thin 2019 corpus"
  - "idiomatic/grammar/data/units_fip.json: it_congiuntivo_presente trigger and form inventory"
---
...
TL: Abbiamo bisogno di una nuova tecnologia che riesca...
...
TL: So che Marco è pronto.

TL: Dubito che Marco sia pronto.
...
TL: È possibile che il piano funzioni.
...
TL: Il direttore chiede che il testo sia più breve.
...
When the desired actor is someone else, use the full clause.
...
TL: È necessario che prendiamo una decisione.

TL: È importante che il pubblico capisca il rischio.

TL: È meglio che lei aspetti.

The indicative returns when the frame reports a fact rather than evaluates or requires it.

TL: È vero che il pubblico capisce il rischio.

The next family is doubt, possibility, and non-commitment.

TL: Non credo che questa soluzione basti.

TL: È possibile che arrivino tardi.
...
TL: Secondo me, è una buona idea.

This is useful because other Romance languages can tempt you to treat every opinion-shaped phrase alike. Retrieve the whole Italian frame, not an abstract cross-language label.

Self-check two. Say, “I don't think this method works.”
...
TL: Mi dispiace che il progetto sia fallito.

TL: È strano che nessuno ne parli.
...
Purpose, pending “before,” and concessive distance are three different meanings, but each prevents the subordinate clause from functioning as a plain new assertion.

Here is self-check three. Say, “I will send you the draft before the meeting begins.”

[PAUSE]

TL: Ti manderò la bozza prima che inizi la riunione.

Another useful contrast concerns existence. If you refer to a known, identified person or thing, the relative clause can state a fact in the indicative.

TL: Conosco un traduttore che sa lavorare in fretta.

If you are looking for someone whose existence or identity is not established, the relative clause describes a desired possibility.

TL: Cerco un traduttore che sappia lavorare in fretta.

The same logic appears after negative or indefinite antecedents.

TL: Non c'è nessuno che possa rispondere.

This relative-clause pattern helps explain the teacher target. The phrase does not merely identify a technology already known to work. It describes the kind of new technology that is needed.
...
TL: che io parli; che tu parli; che lei parli; che loro parlino

For a regular verb in the second conjugation:

TL: che io creda; che tu creda; che lui creda; che loro credano

For a regular verb in the third conjugation:

TL: che io dorma; che tu dorma; che lei dorma; che loro dormano

The forms for we and you plural preserve especially recognizable shapes.

TL: che parliamo; che parliate

TL: che crediamo; che crediate

TL: che dormiamo; che dormiate

The high-frequency irregulars are best learned as sound anchors, not derived under pressure.

TL: sia, abbia, vada, faccia, possa, voglia, debba, sappia, venga, dia

Add a few more that recur in serious conversation.

TL: stia, dica, esca, rimanga, scelga, ponga, tragga, traduca

Many are related to the first-person singular present indicative or preserve a recognizable stem. But during speech, retrieving the whole chunk is faster and safer.

TL: penso che sia

TL: non credo che abbia
...
After a verb of will, the imperfect can also describe the action wanted for later.
...
Then choose relative time, retrieve one high-frequency form, and finish the thought. If necessary, use a simpler verb without abandoning the structure. The production target is not ornamental complexity. It is making stance explicit.

You can also practice one proposition under contrasting frames. Keep the real-world content stable and change only the speaker's relationship to it.

TL: Il progetto funziona.

TL: So che il progetto funziona.

TL: Penso che il progetto funzioni.

TL: Dubito che il progetto funzioni.
